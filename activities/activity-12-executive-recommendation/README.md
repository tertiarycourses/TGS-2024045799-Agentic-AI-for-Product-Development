...
- Required output: One-page decision memo and 90-day rollout scorecard
...
- 5. Execute the activity-specific workflow: Summarise value → Compare evidence → Price risk → Test downside → Set conditions → Recommend.
...
- Pass condition: The recommendation is traceable to evidence, survives a downside scenario, and has measurable exit criteria.
