...
- Required output: Completed opportunity brief and assumption register
...
- 5. Execute the activity-specific workflow: Inspect notes → Name user → Quantify friction → Define outcome → List assumptions → Set validation.
...
- Pass condition: Every claim traces to a source row; the outcome is measurable; high-risk assumptions have named tests.
