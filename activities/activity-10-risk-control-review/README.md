...
- Required output: Risk register, permission map and control test plan
...
- 5. Execute the activity-specific workflow: Map assets → Identify threats → Score exposure → Select controls → Assign owner → Test control.
...
- Pass condition: High risks have preventive and detective controls, named owners and testable evidence.
