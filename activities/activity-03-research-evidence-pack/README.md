...
- Required output: Claim ledger, competitor matrix and three prioritised insights
...
- 5. Execute the activity-specific workflow: Load records → Normalise facts → Triangulate claims → Flag conflict → Rank insight → Cite sources.
...
- Pass condition: Material insights cite at least two records or explicitly state single-source uncertainty.
